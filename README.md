...
This project focuses on cleaning, standardizing, and removing duplicates from the world_layoffs dataset, which tracks layoffs across various companies, industries, and countries. The goal is to ensure that the data is accurate and consistent.
